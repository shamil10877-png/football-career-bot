...
ACHIEVEMENTS = {
    ...
    "champion": {"name": "🏆 Чемпион", "reward": 150000},
...
STADIUM_UPGRADES = [{"name": "Маленький", "cost": 0, "income": 0}, {"name": "Средний", "cost": 200000, "income": 10000}, {"name": "Большой", "cost": 500000, "income": 25000}, {"name": "Супер", "cost": 1500000, "income": 50000}, {"name": "Имени тебя", "cost": 5000000, "income": 150000}]
...
def new_player(name, surname, nation, position, age, height, weight, foot, number):
    now = datetime.now()
...
async def help_cmd(message: Message):
    ...
    text = "📖 <b>Команды</b>\n\n"
    text += "/profile, /train, /match, /rest, /season, /calendar, /transfers, /agent, /shop, /stats, /trophies, /news, /table, /ucl, /contract, /sponsor, /daily, /national, /cars, /house, /family, /business, /history, /donate, /bonus, /achievements, /leaderboard, /penalty, /casino, /tasks, /referral, /reminder, /ping, /myid, /give\n"
    text += "🆕 /rename, /setemoji, /seasons, /cup, /stadium, /merch, /cases, /friends, /club_world_cup, /predict, /stocks"
    if is_coach:
...
async def create(message: Message):
    ...
    if len(args) != 10:
        await message.answer("❌ /create Имя Фамилия Страна Позиция Возраст Рост Вес Нога Номер")
        return
    try:
        age = int(args[5])
        height = int(args[6])
    ...
    if foot not in ("Right", "Left", "Both"):
        ...
        return
    player = new_player(args[1], args[2], args[3], args[4].upper(), age, height, weight, foot, number)
